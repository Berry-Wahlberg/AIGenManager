...
1. **Thread Safety in UI Operations**: Application crashes with "调用线程无法访问此对象，因为另一个线程拥有该对象" (The calling thread cannot access this object because a different thread owns it)
