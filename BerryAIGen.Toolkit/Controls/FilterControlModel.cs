...
public class FilterControlModel : BaseNotify
{
    public FilterControlModel()
    {
        ...
        var comps = new List<NameValue<NodeComparison>>()
        {
            ...
            new() { Name = "greater than", Value = NodeComparison.GreaterThan },
            new() { Name = "greater than or equal", Value = NodeComparison.GreaterThanOrEqual },
            new() { Name = "less than", Value = NodeComparison.LessThan },
            new() { Name = "less than or equal", Value = NodeComparison.LessThanOrEqual },
            new() { Name = "between", Value = NodeComparison.Between },
        };
